...
The OpenLid macOS app has no accounts, telemetry, network client, remote logging, or automatic updates.
...
The website uses Vercel Web Analytics to measure page views. This is separate from the macOS app and does not receive screen captures, lid sensor readings, or app preferences. See [Vercel Web Analytics privacy](https://vercel.com/docs/analytics/privacy-policy).
